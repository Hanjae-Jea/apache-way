...
잠재적 커미터를 찾거나, 커미터로서 의견을 구하거나 적절한 문서를 처리하는 것은 전체 커뮤니티가 기여할 수 있는 점입니다.
...
Apache의 다양한 프로젝트들은 각기 다른 접근 법으로 새 커미터를 모으고 있지만 이 페이지에서는 공통적인 절차에 대해 설명합니다. 또한 꼭 필요한 다양한 커뮤니케이션을 보여줍니다.
...
모든 PMC 멤버들은 메일링 리스트,  Jir, 기타 등등에서 새로운 후보를 정해야 합니다. 아래 팁들은 Apache Forrest 커미터를 뽑기 위한 가이드로도 사용되는 몇 가지 개발된 팁입니다.
